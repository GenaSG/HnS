...
namespace DungeonArchitect.Builders.SimpleCity.Custom
{
    ...
    /// </summary>
    public class LandscapeTransformerCityCustom : LandscapeTransformerBase
    {
        ...
        void UpdateBaseTexture(SimpleCityDungeonModel model, float[,,] map)
        {
            ...
            var activeTextureTypes = new SimpleCityLandscapeTextureType[] {
                ...
                SimpleCityLandscapeTextureType.House,
            };
